...
public class DoctorPrefixAdapter extends ArrayAdapter<String> {
    ...
    public View getDropDownView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null)	{
            ...
            vi = inflater.inflate(com.zenpets.doctors.R.layout.custom_spinner_row, parent, false);

            /** INSTANTIATE THE VIEW HOLDER INSTANCE **/
            holder = new ViewHolder();

            /*****	CAST THE LAYOUT ELEMENTS	*****/
            holder.txtValue = (AppCompatTextView) vi.findViewById(com.zenpets.doctors.R.id.txtValue);
