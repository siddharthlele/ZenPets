...
public class MorningTimeSlotsAdapter extends RecyclerView.Adapter<MorningTimeSlotsAdapter.SlotsVH> {

    /** AN ACTIVITY INSTANCE **/
    private Activity activity;

    /** ARRAYLIST TO GET DATA FROM THE ACTIVITY **/
    private ArrayList<MorningTimeSlotsData> arrSlots;

    public MorningTimeSlotsAdapter(Activity activity, ArrayList<MorningTimeSlotsData> arrSlots) {
