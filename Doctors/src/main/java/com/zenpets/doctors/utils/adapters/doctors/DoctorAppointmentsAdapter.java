...
public class DoctorAppointmentsAdapter extends RecyclerView.Adapter<DoctorAppointmentsAdapter.AppointmentsVH> {
    ...
    public DoctorAppointmentsAdapter(Activity activity, ArrayList<AppointmentsData> arrAppointments) {
    ...
    public AppointmentsVH onCreateViewHolder(ViewGroup parent, int i) {
        ...
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.doctor_calendar_item, parent, false);
