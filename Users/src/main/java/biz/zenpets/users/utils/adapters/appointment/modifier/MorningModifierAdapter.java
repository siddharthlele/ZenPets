...
public class MorningModifierAdapter extends RecyclerView.Adapter<MorningModifierAdapter.SlotsVH> {
    ...
    public MorningModifierAdapter(Activity activity, ArrayList<MorningTimeSlotsData> arrSlots) {
