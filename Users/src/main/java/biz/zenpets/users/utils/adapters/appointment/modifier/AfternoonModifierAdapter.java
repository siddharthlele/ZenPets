...
public class AfternoonModifierAdapter extends RecyclerView.Adapter<AfternoonModifierAdapter.SlotsVH> {
    ...
    public AfternoonModifierAdapter(Activity activity, ArrayList<AfternoonTimeSlotsData> arrSlots) {
