...
public class QuestionsAdapter extends RecyclerView.Adapter<QuestionsAdapter.ConsultationsVH> {

    /***** THE ACTIVITY INSTANCE FOR USE IN THE ADAPTER *****/
    private final Activity activity;

    /***** ARRAY LIST TO GET DATA FROM THE ACTIVITY *****/
    private final ArrayList<QuestionsData> arrConsultations;

    public QuestionsAdapter(Activity activity, ArrayList<QuestionsData> arrConsultations) {
    ...
    public void onBindViewHolder(ConsultationsVH holder, final int position) {
        final QuestionsData data = arrConsultations.get(position);
